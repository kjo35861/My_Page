(() => {
  ...
  data.works.works.forEach(w=>{
    ...
    const action=w.href?`<a class="button primary status" href="${w.href}" target="_blank" rel="noreferrer">논문 열기</a>`:`<span class="button status" aria-disabled="true">13번 완료 후 연결</span>`;
